...
#####################################################################################################################################
def standardize_picture_files(picture_input_dir, picture_file_type, picture_output_dir):
...
# Assign the theme color based on the category from column A of the excel sheet.
		...
		section_info.add_run(milestone_text, style = paragraph_text_style) # Now actually add the header to the MS Word file. 
...
# individual file names:
	text_source_file= data_dir + "/" "better_formatting_update.tsv"
...
#################################################
	standardize_picture_files(picture_dir, picture_output_dir)
